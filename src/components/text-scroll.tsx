...
const TextScroll = (props: Props) => {
	...
	return (
		<div
			className={`flex flex-row items-center border overflow-hidden py-10`}
		>
			<motion.div
			...
			>
				{words?.map((word: string, index: number) => {
					return (
						<div
							key={index}
							className={`w-max border flex flex-row items-center gap-x-5 text-4xl text-white`}
						>
							{word}{" "}
							<span>
								<svg
								...
								>
									<g clip-path="url(#clip0_1327_6963)">
										<path
